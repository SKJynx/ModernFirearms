...
namespace ModernFirearms.Items
{
	public class AWP : ModItem
	{
		...
		{
			DisplayName.SetDefault("AWP");
			Tooltip.SetDefault("Accuracy International Arctic Warfare, uses 7.62x51mm rounds.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.rare = 2;
			item.crit = 31;
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/AWP");
