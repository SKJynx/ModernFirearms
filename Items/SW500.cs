...
{
	public class SW500 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("S&W 500 Magnum");
			Tooltip.SetDefault("Uses .500 rounds.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.rare = 2;
            item.crit = 26;
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/SW500");
			item.autoReuse = false;
			item.shoot = 10; //idk why but all the guns in the vanilla source have this
			item.shootSpeed = 2.2f;
			item.useAmmo = mod.ItemType("Bullet500");
			item.scale = 0.8f;
		}
