...
namespace ModernFirearms.Items
{
	public class Glock17 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.rare = 2;
			item.crit = 11;
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/Glock17");
		...
		{
			Vector2 perturbedSpeed = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(3.6f));
