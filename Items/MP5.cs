...
namespace ModernFirearms.Items
{
	public class MP5 : ModItem
	{
		...
		{
			DisplayName.SetDefault("Heckler & Koch MP5");
			Tooltip.SetDefault("Uses 9mm Parabellum rounds.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.rare = 2;
			item.crit = 2;
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/MP5");
			item.autoReuse = true;
