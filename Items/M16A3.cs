...
{
	public class M16A3 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("M16A3");
			Tooltip.SetDefault("Fully automatic assault rifle. Uses 5.56x45 rounds.");
		}
		...
		public override void SetDefaults()
		{
			...
			item.rare = 2;
			item.crit = 7;
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/M16A3");
			item.autoReuse = true;
